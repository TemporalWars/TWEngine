...
namespace Particles3DComponentLibrary
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        internal Effect ParticleEffect;
        ...
        private EffectParameter _effectMinColor; // 6/1/2012
        private EffectParameter _effectMaxColor; // 6/1/2012
        private EffectParameter _effectGravity; // 6/1/2012
        private EffectParameter _effectEndVelocity; // 6/1/2012
        private EffectParameter _effectColorMultiplier; // 6/1/2012
        ...
        /// <summary>
        /// Gets the current instance of <see cref="ParticleSettings"/>.
        /// </summary>
        ...
        {
            var effect = _content.Load<Effect>(@"Content\ParticleEffect");
            ...
            _effectMinColor = parameters["MinColor"]; // 6/1/2012
            _effectMaxColor = parameters["MaxColor"]; // 6/1/2012
            _effectColorMultiplier = parameters["ColorMultiplier"]; // 6/1/2012
            _effectGravity = parameters["Gravity"]; // 6/1/2012
            _effectEndVelocity = parameters["EndVelocity"]; // 6/1/2012

            // Set the variables, like MinColor and MaxColor
            _effectMinColor.SetValue(Settings.MinColor.ToVector4());
            _effectMaxColor.SetValue(Settings.MaxColor.ToVector4());
            _effectColorMultiplier.SetValue(Settings.ColorMultiplier);
            _effectGravity.SetValue(Settings.Gravity);
            _effectEndVelocity.SetValue(Settings.EndVelocity);
            ...
            var texture = _content.Load<Texture2D>(@"Content\" + Settings.TextureName);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (_firstActiveParticle != _firstFreeParticle)
            {
                ...
                var effectPassCollection = ParticleEffect.CurrentTechnique.Passes;
                var effectCount = effectPassCollection.Count;

                // 6/1/2012 - Upated for Forloop, to reduce garbage on Xbox.
        ...
        // 6/1/2012
        /// <summary>
        /// Sets the min and max colors
        /// that will be used to draw this particle system.
        /// </summary>
        public void SetColors(Color minColor, Color maxColor)
        {
            // set into effect
            if (_effectMinColor != null)
            {
                _effectMinColor.SetValue(minColor.ToVector4());
            }
            if (_effectMaxColor != null)
            {
                _effectMaxColor.SetValue(maxColor.ToVector4());
            }
        ...
        /// <param name="projection">Camera's projection</param>
        ...
        /// <param name="velocity">Paritcle's velocity</param>
        public void AddParticle(Vector3 position, Vector3 velocity)
        {
            ...
            //Vector3 newVelocity;
            Vector3.Multiply(ref velocity, Settings.EmitterVelocitySensitivity, out velocity);
            ...
            double horizontalAngle = RandomGenerator.NextDouble() * MathHelper.TwoPi;
            ...
            var randomValues = new Color((byte)RandomGenerator.Next(255),
                                           (byte)RandomGenerator.Next(255),
                                           (byte)RandomGenerator.Next(255),
                                           (byte)RandomGenerator.Next(255));
