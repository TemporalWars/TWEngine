...
namespace ImageNexus.BenScharbach.TWEngine.ScenaryDataLoader.Enums
{
    // Note: 10/11/2012 - This ENUM list MUST MATCH the list in the TWEngine.
    ///<summary>
    /// <see cref="ItemType"/> Enum, which represents all usable artwork for the game engine.  Using
    /// the ItemTypeAtts, the given artwork name is then coupled with the proper artwork file, 
