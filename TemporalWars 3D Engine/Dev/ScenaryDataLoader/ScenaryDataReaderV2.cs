...
{
    /// <summary>
    /// Content pipeline support class for loading Scenary item content.
    /// </summary>
    public class ScenaryDataReaderV2 : ContentTypeReader<List<ScenaryItemSceneLoader>>
    {
        // 4/9/2009
        ...
        /// <summary>
        /// Reads ScenaryItemData from an XNB file.
        /// </summary>
        ...
        /// </summary>
        /// <param name="item1"><see cref="ImageNexus.BenScharbach.TWEngine.ScenaryDataLoader.Loaders"/> structure</param>
        /// <param name="item2"><see cref="ImageNexus.BenScharbach.TWEngine.ScenaryDataLoader.Loaders"/> structure</param>
