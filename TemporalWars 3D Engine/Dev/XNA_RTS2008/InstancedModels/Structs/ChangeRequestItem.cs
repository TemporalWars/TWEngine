...
{
    // 10/16/2012: Renamed from 'InstancedDataCommunication' to now be 'ChangeRequestItem'.
    // 4/15/2010: Renamed from 'InstancedData' to now be 'InstancedDataCommunication'.
    // 9/12/2008
    ///<summary>
    /// The <see cref="ChangeRequestItem"/> structure is used to communicate updates, between
    ...
    public struct ChangeRequestItem
    {
        // 10/16/2012
        /// <summary>
        /// Current <see cref="ChangeRequestEnum"/> of the type of changeRequest to complete.
        /// </summary>
        public ChangeRequestEnum ChangeRequest;
