...
{
    ///<summary>
    /// The <see cref="RTSCommAttackSceneItem"/> is used to request one <see cref="SceneItem"/>
    /// to attack another <see cref="SceneItem"/>.
    ///</summary>
    public sealed class RTSCommAttackSceneItem : RTSCommand, IPoolNodeItem
    {
        ///<summary>
        /// The network number for the <see cref="SceneItem"/> doing the attacking.
        ///</summary>
        public int SceneItemAttackerNetworkNumber;
        ///<summary>
        /// The player number for the <see cref="SceneItem"/> doing the attacking.
        ///</summary>
        ...
        ///<summary>
        /// Constructor, which passes the <see cref="NetworkCommands.AttackSceneItem"/> Enum to base.
        ///</summary>
        public RTSCommAttackSceneItem()
            : base(NetworkCommands.AttackSceneItem)
        {
        ...
        /// <returns>True/False or result.</returns>
        ...
        public override void ReturnItemToPool()
        {
            ...
            //PoolManager.rtsCommAttackSceneItems.Return(PoolNode);
