...
namespace ImageNexus.BenScharbach.TWEngine.PostProcessEffects.BloomEffect.Enums
{
    // 3/10/2010: NOTE: In order to give the namespace the XML doc, must do it this way;
    /// <summary>
    /// The <see cref="TWEngine.PostProcessEffects.BloomEffect.Enums"/> namespace contains the enumerations
    /// which make up the entire <see cref="TWEngine.TWEngine.PostProcessEffects.BloomEffect.Enumsnent.
    /// </summary>
